...
const BMI = () => {
  ...
  // Inside the calculateBMI function
const calculateBMI = () => {
  setError(null);
  ...
  fetch('http://localhost:3000/api/calculate-bmi', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${localStorage.getItem('token')}`, // Send the token if you have authentication
    },
