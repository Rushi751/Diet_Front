  ...
  return (
    <div className="accordion" id="accordionExample">
      ...
      <AccordionItem
        ...
        content="To lose weight you dont necessarily have to go to the gym but we would recommend at least trying to be more active during the day and increasing the amount of walking you do. Best results tend to come from people who also undertake a basic weight training and cardiovascular exercise programme. The main point to take away here though is that you dont need to exercise excessively to get results!"
      />
